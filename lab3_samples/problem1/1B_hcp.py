...
def lattice_scan():
    ...
    for alat in alat_list:
        ...
        print(output)
        e, f, p, n_unique_k_points, v = output['energy']/13.6057039763/2, output['force'], output['pressure'], output['n_unique_k_points'], output['vol']/2 # volume and energy divide by 2 because hcp primitive cell has 2 atoms
        energies.append(e)
        volumes.append(v)
    ...
    plt.savefig('1B_hcp.png', dpi = 100)
    plt.show()
